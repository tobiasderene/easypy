      ...
      <aside className={`sidebar ${isOpen ? 'active' : ''}`}>
        ...
        <nav className="sidebar-content">
          <ul className="sidebar-menu">
            ...
            <li className="sidebar-item sidebar-accordion">
              ...
              <div className={`sidebar-accordion-content ${isProductsOpen ? 'open' : ''}`}>
                <ul className="sidebar-submenu">
                  ...
                  <li>
                    <button
                      className={`sidebar-sublink ${activePage === 'proveedor' ? 'active' : ''}`}
                      onClick={() => handleLinkClick('/proveedor')}
                    >
                      Proveedor
                    </button>
                  </li>
            ...
            <li className="sidebar-item">
              <button
                className={`sidebar-link ${activePage === 'ordenes' ? 'active' : ''}`}
                onClick={() => handleLinkClick('/ordenes')}
              >
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
