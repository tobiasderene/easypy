        ...
        <nav className="sidebar-content">
          <ul className="sidebar-menu">
            ...
            <li className="sidebar-item sidebar-accordion">
              <button className={`sidebar-accordion-button ${isProductsOpen ? 'active' : ''}`} onClick={() => setIsProductsOpen(!isProductsOpen)}>
                ...
                <svg className={`sidebar-accordion-icon ${isProductsOpen ? 'open' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              <div className={`sidebar-accordion-content ${isProductsOpen ? 'open' : ''}`}>
                <ul className="sidebar-submenu">
                  <li><button className={`sidebar-sublink ${activePage === 'catalogo' ? 'active' : ''}`} onClick={() => handleLinkClick('/catalogo')}>Catálogo</button></li>
                  <li><button className={`sidebar-sublink ${activePage === 'proveedores' ? 'active' : ''}`} onClick={() => handleLinkClick('/proveedores')}>Proveedores</button></li>
                </ul>
              </div>
            </li>

            <li className="sidebar-item">
              <button className={`sidebar-link ${activePage === 'transacciones' ? 'active' : ''}`} onClick={() => handleLinkClick('/transacciones')}>
